...
public class Date1 {
    public static void main(String[] args) {
        ...
        String fullDate = date.format(java.time.format.DateTimeFormatter.ofPattern("EEEE, MMMM d, yyyy", Locale.ITALY));

        // Creazione di una versione formattata della data in formato MEDIUM
        // Mostra il mese abbreviato, giorno e anno
        String mediumDate = date.format(java.time.format.DateTimeFormatter.ofPattern("MMM d, yyyy", Locale.ITALY));

        // Creazione di una versione formattata della data in formato SHORT
        // Mostra la data con mese e anno abbreviati
        String shortDate = date.format(java.time.format.DateTimeFormatter.ofPattern("M/d/yy", Locale.ITALY));
